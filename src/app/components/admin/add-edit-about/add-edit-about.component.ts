...
@Component({
  ...
  styleUrls: ['./add-edit-about.component.scss']
})
export class AddEditAboutComponent implements OnInit {
  ...
  addContent() {
    ...
    let request = this.api.post(this.config.collections.contentPages.about, data);
  ...
  updateContent() {
    ...
    let request = this.api.put(this.config.collections.contentPages.about, this.data[0]?.id, data);
